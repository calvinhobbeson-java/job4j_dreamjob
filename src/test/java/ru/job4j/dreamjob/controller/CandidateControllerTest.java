...
public class CandidateControllerTest {
    ...
    public void whenRequestCandidateCreationPageThenGetPageWithCities() {
        ...
        var model = new ConcurrentModel();
        var view = candidateController.getResumeCreationPage(model);
    ...
    @Test
    public void whenDeleteVacancyThenItIsDeleted() {
        var candidate = new Candidate(1, "test1", "desc1", now(), true, 1, 2);
    ...
    @Test
    public void whenGetVacancyThenGetIt() {
        var candidate = new Candidate(1, "test1", "desc1", now(), true, 1, 2);
        var expectedCandidates = candidate;
        ...
        assertThat(expectedCandidates).isEqualTo(candidate);
    }
}